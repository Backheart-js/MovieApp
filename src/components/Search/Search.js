  ...
  return (
    <div className={clsx(styles.headerSearchWrapper, 'basis-96')}>
        <form className="flex items-center justify-end">   
            ...
            <input value={searchValue} onChange={(e) => handleChange(e.target.value)} type="text" id="simple-search" className="bg-gray-900 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required />
            </div>
        </form>
    </div>
  )
