...
<footer class="container bg-white dark:bg-[#1D2024]">
    <div class="grid grid-cols-2 gap-8 py-8 px-36 md:grid-cols-4">
        <div>
    ...
    <div class="py-6 px-36 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="#">Phimcuzz.com™</a>. All Rights Reserved.
        </span>
