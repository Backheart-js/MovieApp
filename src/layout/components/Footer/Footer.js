...
<footer className="container bg-white dark:bg-black">
    ...
    <div className="py-6 px-36 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="#">Phimcuzz.com™</a>. All Rights Reserved.
        </span>
